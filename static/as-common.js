...
function addPapers(num, dynamic) {
    ...
    for (var i = 0; i < num; i++) {
        ...
        tdiv.append('br');
        tdiv.append('span').classed('as', true).attr('title', p.affiliation).html(build_authors_html(p.authors));
        tdiv.append('br');
        ...
        // show raw arxiv id
        ldiv.append('span').classed('spid', true).attr('title', p.conf_full_name).html(p.conf_full_name_trunc);
